...
import { getAllUsers, toggleUserStatusAPI } from "../../services/admin.js";
...
const UsersList = () => {
  ...
  return (
    <main className="flex-1 p-4 md:p-8">
          ...
          <div className="flex flex-col w-full md:w-auto">
            ...
            <div className="relative w-full md:w-44">
              <select
                ...
                className="appearance-none w-full bg-white border border-gray-300 text-gray-700 text-sm rounded-xl
      ...
      <div className="hidden md:block overflow-x-auto bg-white border border-gray-100 rounded-lg shadow-md">
