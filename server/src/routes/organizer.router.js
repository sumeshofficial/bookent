...
organizerRouter.get("/:organizerId/stadiums", protect, getStadiumsForOrganizer);
...
organizerRouter.get("/stadium/:stadiumId", protect, getStadium);
...
organizerRouter.patch("/stadium/:stadiumId", protect, updateStadium);
organizerRouter.patch("/stadium/:stadiumId/delete", protect, deleteStadium);
